...
import "./Registration_cod.css"
import { Link } from 'react-router-dom'


import { useHistory } from "react-router-dom";

const Registration_cod = () => {
    ...
    const register_player = async(e) =>
    {
        ...
        const res = await fetch("/users/registration_cod", {
            method:"POST",
            headers:{
    ...
    return (
       <>
        ...
        <body className="image2">
        <div className="Registration-cod-card">
        <h1>REGISTRATION FOR COD</h1>
...
export default Registration_cod
